      ...
      const albums = [
        {
          ...
          "accent-color": "#7C2E70",
          url: "https://imagesvc.meredithcorp.io/v3/mm/image?url=https%3A%2F%2Fstatic.onecms.io%2Fwp-content%2Fuploads%2Fsites%2F6%2F2022%2F10%2F20%2FMidnights-Taylor-Swift-01-101922.jpg",
          spotify:
        ...
        },
        {
          ...
          "accent-color": "#873D78",
          url: "https://lastfm.freetls.fastly.net/i/u/770x0/8f38633dcc27d6a20f8880c5774af9d5.jpg",
          spotify:
        ...
        },
        {
          ...
          "accent-color": "#505050",
          url: "https://i.pinimg.com/originals/cc/f4/56/ccf4564928c46baca09fcc0738ca57f2.jpg",
          spotify:
        ...
        },
        {
          ...
          "accent-color": "#E50619",
          url: "https://mir-s3-cdn-cf.behance.net/project_modules/fs/73a7cf47610727.588f690bb7f29.jpg",
          spotify:
...

        {
          ...
          "accent-color": "#B2C15E",
          url: "https://i.pinimg.com/originals/5a/62/10/5a6210fa476de13afb5a6e07d5ae7dd2.jpg",
          spotify:
      ...
      const updateDisplay = (index) => {
        ...
        sectionContainer.id = `hero-${album.album
          .toLowerCase()
          .replace(" ", "-")}`;
      ...
      const createEmblem = (string, delimiter = "•") => {
        ...
        string.split("").forEach((char, idx) => {
          ...
          if (char === delimiter)
            span.style.color = albums[index]["accent-color"];
          spans.push(span);
        });
